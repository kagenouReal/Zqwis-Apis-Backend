...
import { updateUserLimit, getUserByUsername } from "@/system/lib/account-db";
...
// Direct set as requested (not additive)
updateUserLimit(username, amount);
return NextResponse.json({ status: true, message: message.limit.updated });
} catch {
