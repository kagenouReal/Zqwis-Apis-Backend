...
const clients = [{email: "zqwis1@kage.my",password: "zqwis1"},{email: "zqwis2@kage.my",password: "zqwis2"},{email: "zqwis3@kage.my",password: "zqwis3"},{email: "zqwis4@kage.my",password: "zqwis4"},{email: "zqwis5@kage.my",password: "zqwis5"}].map(
acc =>
new MediaFireUpload(
acc.email,
acc.password
